...
<form method="POST">
	...
	<input type="text" name="name" value="Evandro Oliveira" /><br/><br/>

	<strong>CPF:</strong><br/>
	<input type="text" name="cpf1" value="05347965401" /><br/><br/>

	<strong>Telefone:</strong><br/>
	<input type="text" name="telefone" value="8399999999" /><br/><br/>

	<strong>E-mail:</strong><br/>
	<input type="email" name="email" value="testepp@hotmail.com" /><br/><br/>
	...
	<input type="text" name="cidade" value="Nova Olímpia" /><br/><br/>
